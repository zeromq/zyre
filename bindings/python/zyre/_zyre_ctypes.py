...
lib.zyre_set_silent_timeout.restype = None
lib.zyre_set_silent_timeout.argtypes = [zyre_p, c_int]
...
affect the same timeout value.
        """
        return lib.zyre_set_silent_timeout(self._as_parameter_, interval)
