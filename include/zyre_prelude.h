/*  =========================================================================
    zyre_prelude.h - ZYRE environment

    Copyright (c) the Contributors as noted in the AUTHORS file.
    This file is part of ZYRE, the high-level C binding for 0MQ:
    http://zyre.zeromq.org.
...
#ifndef __ZYRE_PRELUDE_H_INCLUDED__
#define __ZYRE_PRELUDE_H_INCLUDED__
...
#   include <sys/wait.h>
#   include <sys/un.h>
#   include <sys/uio.h>             //  Let ZYRE build with libzmq/3.x
...
//  ZYRE uses uint for array indices; equivalent to unsigned int, but more
//  convenient in code. We define it in zyre_prelude.h on systems that do
...
#if defined (__WINDOWS__)
#   define ZYRE_THREADLS __declspec(thread)
#else
#   define ZYRE_THREADLS __thread
#endif
...
#   endif
#   if  ZMQ_VERSION_MINOR == 0   || (ZMQ_VERSION_MINOR == 1 && ZMQ_VERSION_PATCH < 7)
#       error "ZYRE requires at least libzmq/2.1.7 stable"
#   endif
#endif
